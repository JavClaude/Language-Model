...
from language_model.domain.modeling.model.utils.training import (
    Trainer
)
...
@patch("language_model.domain.modeling.model.utils.training.Trainer._put_model_on_the_device")
@patch("language_model.domain.modeling.model.utils.training.Trainer._train_on_epoch")
def test_trainer_train_method_should_call_train_on_epoch_n_times_when_n_epochs_is_equal_to_n(
        train_on_epoch_mock,
        put_model_on_the_device_mock
):
    # Given
    trainer = Trainer(1)
    model = "a"
    ...
    train_on_epoch_mock.assert_called_with(model, train_dataloader, criterion, optimizer)
    assert train_on_epoch_mock.call_count == n_epochs


@patch("language_model.domain.modeling.model.utils.training.Trainer._put_model_on_the_device")
@patch("language_model.domain.modeling.model.utils.training.Trainer._train_on_epoch")
@patch("language_model.domain.modeling.model.utils.training.Trainer._eval_on_epoch")
def test_trainer_train_method_should_call_eval_on_epoch_n_times_when_n_epochs_is_equal_to_n(
    ...
    # When
    trainer.train(model, train_dataloader, criterion, optimizer, eval_dataloader, n_epochs)
...
@patch("language_model.domain.modeling.model.utils.training.Trainer._clean_gradients")
@patch("language_model.domain.modeling.model.utils.training.Trainer._put_model_to_train_mode")
@patch("language_model.domain.modeling.model.utils.training.Trainer._train_on_batch", return_value="a")
def test_trainer_train_on_epoch_should_call_other_training_utils_methods(
        train_on_batch_mock,
        put_model_to_train_mode_mock,
    ...
    train_on_batch_mock.assert_called_with(model, get_batches_return_value, init_hidden_states_return_value, criterion, optimizer)
    assert train_on_batch_mock.call_count == 10


@patch("language_model.domain.modeling.model.utils.training.Trainer._clean_gradients")
@patch("language_model.domain.modeling.model.utils.training.Trainer._put_model_to_eval_mode")
@patch("language_model.domain.modeling.model.utils.training.Trainer._eval_on_batch", return_value="a")
def test_trainer_eval_on_epoch_should_call_other_eval_utils_methods(
        eval_on_batch_mock,
        put_model_to_eval_mode_mock,
        clean_gradients_mock
):
    # Given
    trainer = Trainer(1)
    ...
    eval_on_batch_mock.assert_called_with(model_mock, get_batches_return_value, init_hidden_states_return_value, criterion)
...
@patch("language_model.domain.modeling.model.utils.training.Trainer._get_model_output", return_value=(1, 2))
@patch("language_model.domain.modeling.model.utils.training.Trainer._detach_hidden_states", return_value=3)
@patch("language_model.domain.modeling.model.utils.training.Trainer._transpose_decoder_output_matrix", return_value=4)
@patch("language_model.domain.modeling.model.utils.training.Trainer._compute_loss", return_value=5)
@patch("language_model.domain.modeling.model.utils.training.Trainer._compute_gradients")
@patch("language_model.domain.modeling.model.utils.training.Trainer._apply_gradient_descent")
@patch("language_model.domain.modeling.model.utils.training.Trainer._increment_iteration")
...
@patch("language_model.domain.modeling.model.utils.training.Trainer._get_model_output", return_value=(1, 2))
@patch("language_model.domain.modeling.model.utils.training.Trainer._transpose_decoder_output_matrix", return_value=3)
@patch("language_model.domain.modeling.model.utils.training.Trainer._compute_loss", return_value=4)
@patch("language_model.domain.modeling.model.utils.training.Trainer._increment_iteration")
